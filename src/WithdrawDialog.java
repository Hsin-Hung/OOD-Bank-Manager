...
public class WithdrawDialog extends JDialog {
    ...
    private void withdraw(ATM atm, BankAccount account) {
        ...
        if (atm.withdraw(atm.getLoggedInCustomer(), account, amount)) {
            JOptionPane.showMessageDialog(contentPane, "Withdraw " + account.getCurrency() + " " + amount.toPlainString() + " success.");
        } else {
            JOptionPane.showMessageDialog(contentPane, "Withdraw action failed.");
        }
